        ...
        <div className="grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden border border-border shadow-xl">
              ...
              <img src="/Images/handshake.webp" alt="About Sajad Digital Services" loading="lazy" decoding="async" className="w-full h-[380px] sm:h-[460px] lg:h-[560px] object-cover" />
            </div>
            {/* floating logo badge */}
